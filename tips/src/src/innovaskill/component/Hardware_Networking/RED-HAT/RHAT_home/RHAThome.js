...
import fullstackimage from "../Images_RHAT/13.png"
import './RHAThome.css';
...
export default function RHAThome() {
  return (
      ...
      <div className="ccna_section1 row ">
        ...
        <div className="ccna_sec1div1 col-12 col-sm-12 col-md-12 col-lg-9 col-xl-9 ">
          ...
          <section className="ccna_modulesection row  p-0 m-0">
            ...
            <b>RHCSA</b>
              <li>
                <a href="#ccna_syllabusfullsection">Module1 : RH124 SYSTEM ADMINISTRATOR -1</a>
              </li>
              <li>
                <a href="#ccna_syllabusfullsection">Module2 : RH134 SYSTEM ADMINISTRATOR -II</a>
              </li>
            
            </div >
            <div className="me-sm-0 me-md-0 me-lg-5 col-12 col-sm-12 col-md-6 col-lg-6 mt-3">
            <b>RHCE (AS1 & AS2)</b>
              <li>
                <a href="#ccna_syllabusfullsection">Module3 : RH255 SYSTEM ADMINISTRATOR -III </a>
              </li>
            </div>
