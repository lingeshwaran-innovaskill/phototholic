...
import fullstackimage from "../Images_SOLAR/35.png"
      ...
      <div className="ccna_section1 row ">
        ...
        <div className="ccna_sec1div1 col-12 col-sm-12 col-md-12 col-lg-9 col-xl-9 ">
          ...
          <section className="ccna_modulesection  p-0 m-0">
            ...
            <div>
              <li>
                <a href="#ccna_syllabusfullsection">Module1 : Introduction to Solar Power System</a>
              </li>
              <li>
                <a href="#ccna_syllabusfullsection">Module2 : Add-on Support</a>
              </li>
              <li>
                <a href="#ccna_syllabusfullsection">Module3 : Vendor Registration for Solar </a>
              </li>
