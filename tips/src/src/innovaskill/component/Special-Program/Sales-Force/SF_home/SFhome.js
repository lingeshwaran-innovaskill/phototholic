...
import fullstackimage from "../Images_SF/fullstack_sec1image.avif"
import './SFhome.css';
      ...
      <div className="ccna_section1 row ">
        ...
        <div className="ccna_sec1div1 col-12 col-sm-12 col-md-12 col-lg-9 col-xl-9 ">
          ...
          <section className="ccna_modulesection p-0 m-0">
            ...
            <div>
              <li>
                <a href="#ccna_syllabusfullsection">Module1 :  Introduction to Salesforce</a>
              </li>
              <li>
                <a href="#ccna_syllabusfullsection">Module2 : Configuration and Customization</a>
              </li>
              <li>
                <a href="#ccna_syllabusfullsection">Module3 : Data access and security </a>
              </li>
              <li>
                <a href="#ccna_syllabusfullsection">Module4 : Automation </a>
              </li>
              <li>
                <a href="#ccna_syllabusfullsection">Module5 : Data management </a>
              </li>
              <li>
                <a href="#ccna_syllabusfullsection">Module6 : Development</a>
              </li>
