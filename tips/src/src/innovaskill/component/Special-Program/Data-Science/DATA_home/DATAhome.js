...
import fullstackimage from "../Images_DATA/29.png";
import './DATAhome.css';
    ...
    <div className='container-fluid'>
      <div className="dl_section1 row ">
        ...
        <div className="dl_sec1div1 col-12 col-sm-12 col-md-12 col-lg-9 col-xl-9 ">
          ...
          <section className="dl_modulesection row p-0 m-0">
            {/* <div className='row'> */}
            
            <div>
              <li>
                <a href="#dl_syllabusfullsection">Module1 : Python</a>
              </li>
              <li>
                <a href="#dl_syllabusfullsection">Module2 : Structured Query Language (SQL)</a>
              </li>
              <li>
                <a href="#dl_syllabusfullsection">Module3 : Numerical Python (Numpy)</a>
              </li>
              <li>
                <a href="#dl_syllabusfullsection">Module4 : Matplotlib</a>
              </li>
              <li>
                <a href="#dl_syllabusfullsection">Module5 : Pandas</a>
              </li>
              <li>
                <a href="#dl_syllabusfullsection">Module6 : Machine Learning (ML)</a>
              </li>
              <li>
                <a href="#dl_syllabusfullsection">Module7 : Deep Learning (DL)</a>
              </li>
            </div>
