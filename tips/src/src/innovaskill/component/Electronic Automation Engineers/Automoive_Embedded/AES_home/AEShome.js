...
import fullstackimage from "../Images_AES/4 (1).png"
import './AEShome.css';
...
export default function AEShome() {
  return (
      ...
      <div className="ccna_section1 row ">
        ...
        <div className="ccna_sec1div1 col-12 col-sm-12 col-md-12 col-lg-9 col-xl-9 ">
          ...
          <section className="ccna_modulesection  p-0 m-0">
            ...
            <div>
              <li>
                <a href="#ccna_syllabusfullsection">Module1 : C Programming</a>
              </li>
              <li>
                <a href="#ccna_syllabusfullsection">Module2 : ARM7  </a>
              </li>
              <li>
                <a href="#ccna_syllabusfullsection">Module3 : Automotive Embedded System Design </a>
              </li>
