...
import fullstackimage from "../Images_IOT/5 (1).png"
import './IOThome.css';
        ...
        <div className="ccna_sec1div1 col-12 col-sm-12 col-md-12 col-lg-9 col-xl-9 ">
          ...
          <section className="ccna_modulesection  p-0 m-0">
            ...
            <div className="col-12 col-sm-12 col-md-6 col-lg-6">
              <li>
                <a href="#ccna_syllabusfullsection">Module1 : Arduino Microcontroller</a>
              </li>
              <li>
                <a href="#ccna_syllabusfullsection">Module2 : Project Title Based on Arduino Microcontroller</a>
              </li>
              <li>
                <a href="#ccna_syllabusfullsection">Module3 : ESP32 Controller </a>
              </li>
              <li>
                <a href="#ccna_syllabusfullsection">Module4 : Project Title Based on ESP32 Microcontroller </a>
              </li>
